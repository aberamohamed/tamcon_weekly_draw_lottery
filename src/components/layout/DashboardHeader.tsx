    ...
    <header className="h-16 border-b bg-white fixed top-0 left-0 right-0 z-[60] px-4 md:px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-2 md:gap-6">
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-zinc-200">
          <Avatar className="h-10 w-10 border-4 border-zinc-50/50">
          ...
          <div className="hidden md:block text-left">
            <p className="text-[13px] font-black text-[#2D338B] tracking-tight uppercase leading-none">{displayName}</p>
            <p className="text-[10px] text-zinc-400 font-bold uppercase tracking-[0.1em] mt-1">Administrator</p>
          </div>
